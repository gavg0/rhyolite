...
BINARY_URL="https://github.com/RedddFoxxyy/Rhyolite/releases/download/v0.1.2/Rhyolite_0.1.2_x86_64_linux_binary"  # Update with your binary's URL
ICON_URL="https://raw.githubusercontent.com/RedddFoxxyy/Rhyolite/master/src-tauri/icons/icon.png"  # Update with your app's icon URL
